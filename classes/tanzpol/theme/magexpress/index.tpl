...
<html lang="en">
  <head>
    ...
    <title>magExpress by WpFreeware.com</title>
    ...
    <link href="{$asset_path}/css/slick.css" rel="stylesheet">     
    <!-- <link href="{$asset_path}/css/theme-red.css" rel="stylesheet"> -->  
      <link href="{$asset_path}/css/theme.css" rel="stylesheet">	 
    <!-- main site css file -->    
...
<body>
        ...
        <div class="col-lg-12 col-md-12">
          ...
          <div class="header_bottom">
            ...
            <!-- <a class="logo" href="index.html">
              <img src="{$asset_path}/img/logo.jpg" alt="logo">
             </a>-->
             <!-- for text logo -->
              <a class="logo" href="index.html">
               mag<strong>Express</strong> <span>A Pro Magazine Wordpress Theme</span>
             </a> 
			 
            </div>
            <div class="header_bottom_right">
              <a href="http://wpfreeware.com"><img src="{$asset_path}/img/addbanner_728x90_V1.jpg" alt="img"></a>
            </div>
              ...
              <div class="latest_slider">
                ...
                <div class="slick_slider">
                  <div class="single_iteam">
                    <img src="{$asset_path}/img/devhill/550x330x1.jpg" alt="img">
                    <h2><a class="slider_tittle" href="single.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
                  </div>
                  <div class="single_iteam">
                    <img src="{$asset_path}/img/devhill/550x330x2.jpg" alt="img">
                    <h2><a class="slider_tittle" href="single.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
                  </div>
                  <div class="single_iteam">
                    <img src="{$asset_path}/img/devhill/550x330x3.jpg" alt="img">
                     <h2><a class="slider_tittle" href="single.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
                  </div>
                  <div class="single_iteam">
                    <img src="{$asset_path}/img/devhill/550x330x4.jpg" alt="img">
                     <h2><a class="slider_tittle" href="single.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm6">
              <div class="content_top_right">
                <ul class="featured_nav wow fadeInDown">
                  <li>
                    <img src="{$asset_path}/img/devhill/300x215x1.jpg" alt="img">
                    <div class="title_caption">
                      <a href="single.html">
                        Sed luctus semper odio aliquam rhoncus
                      </a>
                    </div>
                  </li>
                  <li>
                    <img src="{$asset_path}/img/devhill/300x215x2.jpg" alt="img">
                    <div class="title_caption">
                      <a href="single.html">
                        Sed luctus semper odio aliquam rhoncus
                      </a>
                   ...
                   <li>
                    <img src="{$asset_path}/img/devhill/300x215x3.jpg" alt="img">
                    <div class="title_caption">
                      <a href="single.html">
                        Sed luctus semper odio aliquam rhoncus
                      </a>
                   ...
                   <li>
                    <img src="{$asset_path}/img/devhill/300x215x4.jpg" alt="img">
                    <div class="title_caption">
                      <a href="single.html">
                        Sed luctus semper odio aliquam rhoncus
                      </a>
              ...
              <div class="single_category wow fadeInDown">
                ...
                <ul class="catg1_nav">
                  <li>
                    <div class="catgimg_container">
                      <a href="single.html" class="catg1_img">
                        <img alt="img" src="{$asset_path}/img/devhill/292x150x1.jpg">
                      </a>
                    </div>
                  ...
                  <li>
                    <div class="catgimg_container">
                      <a href="single.html" class="catg1_img">
                        <img alt="img" src="{$asset_path}/img/devhill/292x150x2.jpg">
                      </a>
                    </div>
                    <h3 class="post_titile"><a href="single.html">Vestibulum ut est augue, in varius</a></h3>
                  </li>
            ...
            <div class="content_middle_middle">
              <div class="slick_slider2">
                <div class="single_featured_slide">
                  <a href="single.html"><img src="{$asset_path}/img/devhill/567x330x1.jpg" alt="img"></a>
                ...
                <div class="single_featured_slide">
                  <a href="single.html"><img src="{$asset_path}/img/devhill/567x330x2.jpg" alt="img"></a>
                  <h2><a href="#">Praesent vitae quam vitae arcu posuer 2</a></h2>
                  <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui lectus, pharetra nec elementum eget, vulput...</p>
                </div>
                <div class="single_featured_slide">
                  <a href="single.html"><img src="{$asset_path}/img/devhill/567x330x3.jpg" alt="img"></a>
                    ...
                    <ul class="fashion_catgnav">
                      <li>
                        <div class="catgimg2_container">
                          <a href="single.html"><img alt="img" src="{$asset_path}/img/devhill/390x240x1.jpg"></a>
                        </div>
                      ...
                      <li>
                        <div class="media wow fadeInDown">
                          <a class="media-left" href="single.html">
                            <img src="{$asset_path}/img/devhill/112x112.jpg" alt="img">
                          </a>
                    ...
                    <div class="single_category">
                      <div class="single_category wow fadeInDown">
                        ...
                        <ul class="fashion_catgnav wow fadeInDown">
                          <li>
                            <div class="catgimg2_container">
                              <a href="#"><img alt="img" src="{$asset_path}/img/devhill/390x240x1.jpg"></a>
                            </div>
                            <h2 class="catg_titile"><a href="#">Aenean mollis metus sit amet ligula adipiscing</a></h2>
                            <div class="comments_box">
                              <span class="meta_date">14/12/2013</span>
                    ...
                    <li>
                      <div class="media wow fadeInDown">
                        <a href="#" class="media-left">
                          <img alt="img" src="{$asset_path}/img/devhill/112x112.jpg">
                        </a>
                        <div class="media-body">
                          <h4 class="media-heading"><a href="#">Duis condimentum nunc pretium lobortis </a></h4> 
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
              <div class="single_footer_top wow fadeInLeft">
                ...
                <ul class="flicker_nav">
                  <li>
                      <a href="#"><img src="{$asset_path}/img/devhill/75x75.jpg" alt="img"></a>
                  </li>                 
                  <li>
                      <a href="#"><img src="{$asset_path}/img/devhill/75x75.jpg" alt="img"></a>
                  </li>
  ...
  <script src="{$asset_path}/js/slick.min.js"></script> 
